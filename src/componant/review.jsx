...
//         setMistakes(lastReview[i]);

//         await axios.post("http://localhost:5000/Mistakes/",lastReview[i]);

//       }
//     }
//     // await axios.put("http://localhost:5000/Mistakes",{})
//    const {oldMistakes}= await axios.get("http://localhost:5000/Statistics/1");
   

//     await axios.patch("http://localhost:5000/Statistics/1",{Mistakes:(oldMistakes+mistakes.length)})
